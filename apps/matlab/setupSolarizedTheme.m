function varargout = setupSolarizedThemeTheme(varargin) %#ok<STOUT>
%===============================================================================
% FUNCTION: 
%   setupSolarizedTheme.m
%
% PURPOSE: 
...
%
% EXAMPLE:
%   o setupSolarizedTheme('light');
%   o setupSolarizedTheme('dark');
%   o setupSolarizedTheme('default');
%===============================================================================
